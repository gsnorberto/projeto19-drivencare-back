...
appointmentRoutes.post('/doctors/:doctorId/schedule', appointmentControllers.addAvailableTime)
appointmentRoutes.get('/doctors/:doctorId/schedule', appointmentControllers.getAvailableTime)

appointmentRoutes.post('/schedule', validateSchema(appointmentSchemas.schedule), appointmentControllers.scheduleAppointment)
